 ...
 * 
 */
@WebServiceClient(name = "WsImplService", targetNamespace = "http://exam.mycompany.com/", wsdlLocation = "http://localhost:8080/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://exam.mycompany.com/", "WsImplService");
    ...
    public WsInterface getWsImplPort() {
        return super.getPort(new QName("http://exam.mycompany.com/", "WsImplPort"), WsInterface.class);
    }
    ...
    public WsInterface getWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://exam.mycompany.com/", "WsImplPort"), WsInterface.class, features);
    }
